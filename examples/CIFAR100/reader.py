import pickle,torch,urllib,tarfile,os
...
def create_readers(train_num=50000,test_num=10000//4,batch_size=64):
    ...
    if not os.path.isdir("cifar-100-python/"):
        ...
        urllib.request.urlretrieve("https://www.cs.toronto.edu/~kriz/cifar-100-python.tar.gz","cifar-100-python.tar.gz")
        with tarfile.open('cifar-100-python.tar.gz') as zip_ref:
            zip_ref.extractall('./')
