...
class LearnerModel(nn.Module):
    ...
    def __init__(self, encoder_size=None, decoder_size=None, encoder_optimizer=None, decoder_optimizer=None, max_length = 12):
        '''
    ...
    def forward(self, input_seq, target_tensor):
        '''
        ...
        decoder_output = torch.tensor(out_lst, device=device)
