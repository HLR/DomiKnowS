...
This script runs the model which uses the entailment process as output.
Imported pyswip prolog wrapper to run prolog queries for the entailment function.
The model does not use any corrections here.
