...
if __package__ is None or __package__ == '':
    from data_bert import Conll04SpaCyBinaryReader as Reader
...
def model_declaration(graph, config):
    ...
    word['emb'] = SentenceEmbedderSensor('word', config.pretrained_dims['word'], sentence['raw'], pretrained_file=config.pretrained_files['word'])
