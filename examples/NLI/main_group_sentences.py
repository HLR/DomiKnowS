...
def program_declaration():
    ...
    sentence_group["hypothesises"] = ReaderSensor(keyword="hypothesis")
    ...
    sentence["robert_emb"] = ModuleLearner("token_id", "Mask", module=roberta_model)
    ...
    sentence[entailment] = FunctionalSensor(sentence_group_contains, "entailment", forward=read_label, label=True)
    sentence[neutral] = FunctionalSensor(sentence_group_contains, "neutral", forward=read_label, label=True)
    sentence[contradiction] = FunctionalSensor(sentence_group_contains, "contradiction", forward=read_label, label=True)
