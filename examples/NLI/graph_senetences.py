...
with Graph('Useful_arg') as graph:
    ...
    ifL(contradiction('x'), contradiction(path=('x', symmetric, s_sent2)))
    ...
    ifL(andL(entailment('x'), entailment(path=('x', transitive, t_sent2))),
        entailment(path=('x', transitive, t_sent3)))
