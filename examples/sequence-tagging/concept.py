...
with Graph('bio_graph') as graph:
    ...
    (bio_1, bio_2) = before.has_a(word,word)
    ...
    # eos = word(name="<eos>")
    # out_bio = word(name="O")
    # i_PER = word(name="I-PER")
    # i_ORG = word(name="I-ORG")
    # i_LOC = word(name="I-LOC")
    # i_MISC = word(name="I-MISC")
    # b_MISC = word(name="B-MISC") ### how to insert b_MISC.before.i_MISC
    # b_ORG = word(name="B-ORG")   ### how to insert b_ORG.before.i_ORG
    # b_LOC = word(name="B-LOC")   ### how to insert b_LOC.before.i_LOC
