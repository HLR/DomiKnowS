...
def model_declaration(graph, data, reader):
    ...
    # next(sentence['flair'].find(SentenceFlairEmbedderSensor))(data_item={})
    ...
    # next(sentence['output'].find(CallingSensor))(data_item={})
    #
    ...
    return ACEsolver
    #
    # next(sentence['encode'].find(CallingSensor))(data_item={})
