...
with Graph(name='global') as graph:
    ...
    andL(andL(p1_is_real("x"),work_in1("z",path=('x', people_arg1.reversed))),andL(p2_is_real("y"),work_in2("t",path=('y', people_arg2.reversed))))
    orL(andL(p2_is_real("x"),work_in2("z",path=('x', people_arg2.reversed))),andL(p3_is_real("y"),work_in3("t",path=('y', people_arg3.reversed))))
...
program = PrimalDualProgram(graph,SolverModel,poi=[p1,p2,p3,l1,l2,l3,pair1,pair2,pair3],device="cpu")
