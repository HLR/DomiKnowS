...
# torch.manual_seed(4)
# data_list = generate_dataset(sample_num=10)
# data_list = reader_format(data_list)
# json.dump(data_list, open("dataset_10.json", "w"), indent=3)
with open("dataset_10.json", "r") as jsonf:
...
# print(list(program.model.parameters()))
program.train(data_list, Optim=lambda param: torch.optim.AdamW(param, 1e-3), train_epoch_num=100, c_lr=1e-4, c_warmup_iters=-1, device="cpu")
