...
print("Acc train before training:", program.evaluate_condition(train, device="cpu"), file=output_file)
print("Acc test before training:", program.evaluate_condition(test, device="cpu"), file=output_file)
# print(list(program.model.parameters()))
train_epoch_num = 30
...
print("Acc train after training:", program.evaluate_condition(train, device="cpu"), file=output_file)
print("Acc test after training:", program.evaluate_condition(test, device="cpu"), file=output_file)
# print(list(program.model.parameters()))
output_file.close()