...
def conll4_reader(data_path, dataset_portion, reward_function=None):
    ...
    for portion in ["train", "validation", "test"]:
        ...
        for data in dataset[portion]:
            ...
            sample_reward_function = reward_function or make_reward_function(str_query, label_query)
            ...
            item = {
                ...
                "reward_function": sample_reward_function,
            }
            current_portion.append(item)
...
if __name__ == '__main__':
    conll4_reader("data2.json", "entities_with_relation")