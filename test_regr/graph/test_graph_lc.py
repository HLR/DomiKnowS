    ...
    def test_what(self):
        ...
        with Graph('global') as graph:
            ...
            with Graph('application') as app_graph:
                ...
                app_graph.andL(people, organization)
                app_graph.andL(app_graph.orL(other, o), organization)
                app_graph.ifL(app_graph.andL(app_graph.orL(other, o), organization), app_graph.andL(people, organization))
