...
with Graph('global') as graph:
    ...
    # Global Constraints, making sure that maximum of each concept is 3
    atMostAL(people, 3)
    atMostAL(organization, 3)
    atMostAL(location, 3)

    # Global Constraints, making sure that at least 1 people appear
    atLeastAL(location, 1)
