...
parser.add_argument('--constraint', dest='constraint',default="foreach_bag_existsL_notL", choices=["None","simple_constraint","foreach_bag_existsL","foreach_bag_existsL_notL","foreach_bag_atLeastAL","foreach_bag_atMostAL"], help="Choose a constraint")
parser.add_argument('--atmostaL', dest='atmostaL',default=4,type=int)
