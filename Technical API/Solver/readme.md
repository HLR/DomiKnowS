...
(*[AND](../../Technical%20API/Graph/Class%20LogicalConstrain.md#andL)*, *[OR](../../Technical%20API/Graph/Class%20LogicalConstrain.md#orL)*, *[IF](../../Technical%20API/Graph/Class%20LogicalConstrain.md#ifL)*, *[NAND](../../Technical%20API/Graph/Class%20LogicalConstrain.md#nandL)*, *[XOR](../../Technical%20API/Graph/Class%20LogicalConstrain.md#xorL)*, *[EPQ](../../Technical%20API/Graph/Class%20LogicalConstrain.md#eqL)*, *[NOR](../../Technical%20API/Graph/Class%20LogicalConstrain.md#norL)*, *[NOT](../../Technical%20API/Graph/Class%20LogicalConstrain.md#notL)*) into the ILP equations.  

The solver [implementation using Gurobi](./Class%20ilpOntSolver.md) is called with probabilities for token classification obtained from learned model. The solver encodes mapping from OWL constrains to the appropriate equivalent logical expression for the given graph and the provided probabilities. 
